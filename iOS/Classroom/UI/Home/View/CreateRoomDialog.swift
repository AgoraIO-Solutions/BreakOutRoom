...
protocol CreateRoomDelegate: BaseViewContoller {
    func createRoom(with: String?) -> Observable<Result<ClassroomRoom>>
    func onCreateSuccess(with: ClassroomRoom)
    func onDismiss()
}
...
class CreateRoomDialog: UIView {
    ...
    private func onCreateRoom() -> Observable<Result<ClassroomRoom>> {
