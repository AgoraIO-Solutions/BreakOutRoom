...
class SpeakerGroup {
    var hoster: ClassroomMember?
    var leftSpeaker: ClassroomMember?
    var rightSpeaker: ClassroomMember?
    
    func sync(list: Array<ClassroomMember>) {
...
class MemberGroup {
    ...
    var list: Array<ClassroomMember>
    
    init() {
        self.list = []
    }
    
    func sync(list: Array<ClassroomMember>) -> (Bool, Array<ClassroomMember>) {
...
class RoomChat {
    var member: ClassroomMember
    var message: String
    
    init(member: ClassroomMember, message: String) {
...
class RoomViewModel {
    ...
    var roomManager: ClassroomMember? = nil
    ...
    var handsupList: [ClassroomAction] = []
    var onHandsupListChange: BehaviorRelay<[ClassroomAction]> = BehaviorRelay(value: [])

    var onMemberEnter: BehaviorRelay<ClassroomMember?> = BehaviorRelay(value: nil)
    
    var messageList: [RoomChat] = []
    
    func actionsSource() -> Observable<Result<ClassroomAction>> {
    ...
    func process(action: ClassroomAction, agree: Bool) -> Observable<Result<Void>> {
