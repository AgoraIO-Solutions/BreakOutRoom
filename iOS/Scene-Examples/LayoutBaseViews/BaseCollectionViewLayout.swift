...
@objc
protocol BaseCollectionViewLayoutDelegate {
...
class BaseCollectionViewLayout: UIView {
    //MARK: Public
...
extension BaseCollectionViewLayout: UICollectionViewDataSource {
...
extension BaseCollectionViewLayout: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        delegate?.collectionView?(collectionView, didSelectItemAt: indexPath)
    }
}

extension BaseCollectionViewLayout: UICollectionViewDelegateFlowLayout {
...
class BaseEmptyView: UIView {
    ...
    private lazy var descriptionLabel: UILabel = {
        let label = UILabel()
        label.text = "Create_A_Live_Room".localized
